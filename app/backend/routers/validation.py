...
_MOCK_RULES_3040_EN = [
    _mock_vr(rule_id="S20_001", run_config_name=_RC_3040_CLI,
             check_name="autorzc_in_dominio", dqx_check_function="sql_expression",
             rule_name="Autorzc outside the {S,N} domain", rule_type="syntactic",
             severity="error", dimension_r18=3, dimension_name="Adaptability", status="fail",
             affected_records=12, total_records=50000000, nivel=1,
             description="12 customers with Autorzc outside the {S,N} domain of the SCR 3040 layout."),
    _mock_vr(rule_id="S20_002", run_config_name=_RC_3040_CLI,
             check_name="porte_cli_in_dominio_por_tipo", dqx_check_function="sql_expression",
             rule_name="PorteCli invalid for the customer type", rule_type="syntactic",
             severity="error", dimension_r18=3, dimension_name="Adaptability", status="fail",
             affected_records=7, total_records=50000000, nivel=1,
             description="7 customers with PorteCli outside the domain conditional on type (PF: 0-8; PJ: 0-4)."),
    _mock_vr(rule_id="S20_003", run_config_name=_RC_3040_CLI,
             check_name="tp_ctrl_in_dominio", dqx_check_function="sql_expression",
             rule_name="TpCtrl outside the {01..04} domain", rule_type="syntactic",
             severity="error", dimension_r18=3, dimension_name="Adaptability", status="pass",
             affected_records=0, total_records=50000000, nivel=1,
             description="TpCtrl within the official domain {'01','02','03','04'} of the SCR 3040 layout."),
    _mock_vr(rule_id="S10_004", run_config_name=_RC_3040_OPER,
             check_name="dia_atraso_nao_negativo", dqx_check_function="sql_expression",
             rule_name="DiaAtraso negative", rule_type="syntactic",
             severity="error", dimension_r18=2, dimension_name="Accuracy", status="pass",
             affected_records=0, total_records=50000000, nivel=1,
             description="DiaAtraso within the expected range — all values are non-negative integers."),
]
