<script>
  ...
  const initialApiNodes = [
    ...
    { id: `${CATALOG}.silver.operacoes`, label: 'operacoes',                         type: 'table',           layer: 'silver', metadata: { row_count: 1, last_updated: '2026-03-31T01:30:00Z', expectations_pass_rate: 99.9 } },
    { id: `${CATALOG}.silver.clientes`,  label: 'clientes',                          type: 'table',           layer: 'silver', metadata: { row_count: 1, last_updated: '2026-03-31T01:30:00Z' } },
  ...
  const initialApiEdges = [
    ...
    { source: `${CATALOG}.bronze.raw_3040_doc`,   target: `${CATALOG}.silver.operacoes`,           type: 'uc_automatic', label: 'DLT silver' },
    { source: `${CATALOG}.bronze.raw_3040_doc`,   target: `${CATALOG}.silver.clientes`,            type: 'uc_automatic', label: 'DLT silver' },
    { source: `${CATALOG}.silver.operacoes`,           target: `${CATALOG}.gold.posicao_mensal_3040`, type: 'uc_automatic', label: 'DLT gold' },
